                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body p-4">
                                                                    <form action="/editbannerpromopost/{{ $promo->id }}"
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    <label for="field-3"
                                                                                        class="form-label">Sub Judul Promo
                                                                                        :</label>
                                                                                    <input type="text" id="subjudul"
                                                                                        name="subjudul"
                                                                                        class="form-control"
                                                                                        value="{{ $promo->subjudul }}"
                                                                                        id="field-3"
                                                                                        placeholder="Masukan Sub Judul Promo">
                                                                                </div>
                                                                                <div class="mb-3">
                                                                                    <label for="field-3"
